...
public class Testdrive extends OpMode {
    // THIS IS where we put our public variables that are stored in the opmodes class
    public double LauncherCloseMax = 1500;
    public double LauncherCloseMin = 1490;
    public double LauncherFarMax = 1700;
    public double LauncherFarMin = 1690;
    ...
    public void loop() {
        ...
        telemetry.addData("right stick x", Math.abs(gamepad1.right_stick_x));
